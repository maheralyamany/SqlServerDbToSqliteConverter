namespace SqlServerDbToSqliteConverter
{
    partial class TableSelectionDialog
    {
        ...
        private void InitializeComponent()
        {
			...
			this.colTableType = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.colTableName.HeaderText = "Name";
			...
			// colTableType
			// 
			this.colTableType.FillWeight = 30F;
			this.colTableType.HeaderText = "Type";
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn colTableType;
	}
}